//
//  RatingSizeAttributesUseCaseDeprecated.swift
...
protocol RatingSizeAttributesUseCaseDeprecatedable {
    func execute(spacing: any LayoutSpacing, size: RatingDisplaySize) -> RatingSizeAttributesDeprecated
}

/// Calculates size attributes of the rating display according to the spacing and the size.
@available(*, deprecated, message: "Not used anymore by the new SparkRatingInput/SparkRatingDisplay or SparkUIRatingInput/SparkUIRatingDisplay")
struct RatingSizeAttributesUseCaseDeprecated: RatingSizeAttributesUseCaseDeprecatedable {
...
private extension RatingDisplaySize {
    func sizeAttributes(spacing: CGFloat) -> RatingSizeAttributesDeprecated {
        switch self {
