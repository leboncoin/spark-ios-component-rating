...
@available(*, deprecated, message: "Use SparkRatingInput instead")
public struct RatingInputView: View {
    // MARK: - Private variables
    @ObservedObject private var viewModel: RatingDisplayViewModelDeprecated
    @Environment(\.isEnabled) private var isEnabled: Bool
    private var rating: Binding<CGFloat>
    private var configuration: StarConfigurationDeprecated
    ...
    public init(
        ...
        configuration: StarConfigurationDeprecated = .default
    ) {
        self.rating = rating
        self.intent = intent
        self.configuration = configuration
        self.viewModel = RatingDisplayViewModelDeprecated(
            theme: theme,
            intent: intent,
            size: .input,
            count: .five)
...
struct RatingInputInternalView: View {
    ...
    private let configuration: StarConfigurationDeprecated
    ...
    init(
        viewModel: RatingDisplayViewModelDeprecated,
        rating: Binding<CGFloat>,
        configuration: StarConfigurationDeprecated
    ) {
        self._rating = rating
