...
@available(*, deprecated, message: "Use SparkUIRatingDisplay instead")
public class RatingDisplayUIView: UIView {
    ...
    private let viewModel: RatingDisplayViewModelDeprecated
    ...
    private func didUpdate(colors: RatingColorsDeprecated) {
        for view in self.ratingStarViews {
    ...
    private func didUpdate(size: RatingSizeAttributesDeprecated) {
