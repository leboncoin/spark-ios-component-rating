...
public final class StarUIView: UIView {
    ...
    public var configuration: StarConfigurationDeprecated {
        didSet {
    ...
    /// - configuration: StarConfigurationDeprecated, a configuration of the star appearance. The default is `default`.
